...
GTFILES =	verilog_unpipe/pipeline.sv	\
			verilog_unpipe/regfile.sv	\
			verilog_unpipe/if_stage.sv	\
			verilog_unpipe/id_stage.sv	\
			verilog_unpipe/ex_stage.sv	\
			verilog_unpipe/mem_stage.sv	\
			verilog_unpipe/wb_stage.sv	\
...
simv_gt:	$(GTFILES) $(TESTBENCH)
	$(VCS) $(TESTBENCH) $(GTFILES)	-o simv
